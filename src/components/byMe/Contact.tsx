...
export function SignupFormDemo() {
  ...
  return (
    <>
    {/* <h1 className="text-white font-bold text-5xl">Contact Me</h1> */}
    <SparklesPreview  type="Contact" />

      <div className="border-2 border-gray-600 max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black">
        ...
        <form className="my-8" onSubmit={handleSubmit}>
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            <LabelInputContainer>
              ...
              <Input id="firstname" placeholder="Abdelmounaim" type="text" />
            </LabelInputContainer>
            <LabelInputContainer>
              <Label htmlFor="lastname">Last name</Label>
              <Input id="lastname" placeholder="Hmamed" type="text" />
            </LabelInputContainer>
          </div>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="email">Email Address</Label>
            <Input id="email" placeholder="hmamedabdelmounaime@gmail.com" type="email" />
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
